...
class RecyclerViewwAdapterrr extends RecyclerView.Adapter<RecyclerViewwAdapterrr.ViewHolder> {
    ...
    public RecyclerViewwAdapterrr(Context context, List<ImageUploadInfo> TempList) {
