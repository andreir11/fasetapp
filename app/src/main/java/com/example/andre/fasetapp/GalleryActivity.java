...
public class GalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DisplayImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(GalleryActivity.this, DisplayImagesGalleryActivity.class);
    ...
    public void UploadImageFileToFirebaseStorage() {
        ...
        if (FilePathUri != null) {
            ...
            Toast.makeText(GalleryActivity.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
